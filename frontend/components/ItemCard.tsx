...
export default function ItemCard({
  ...
  const displaySyncState = contentSyncState?.state ?? item.sync_state;
  return (
    <div className="admin-item-card">
      <div className="flex w-full items-center gap-3 p-4 transition-colors hover:bg-[rgba(201,168,76,0.06)] relative group">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="font-medium truncate flex items-center gap-2">
              ...
              {displaySyncState === "missing" && !isContentSyncing && (
              ...
              {displaySyncState === "outdated" && !isContentSyncing && (
        ...
        {onForceSyncItem && displaySyncState && (
          <button
            type="button"
