...
LLM_INPUT_PRICE_PER_1M = float(os.getenv("LLM_INPUT_PRICE_PER_1M", "0.075"))
LLM_INPUT_CACHE_HIT_PRICE_PER_1M = float(
    os.getenv("LLM_INPUT_CACHE_HIT_PRICE_PER_1M", "0.014")
)
LLM_INPUT_CACHE_MISS_PRICE_PER_1M = float(
    os.getenv(
        "LLM_INPUT_CACHE_MISS_PRICE_PER_1M",
        os.getenv("LLM_INPUT_PRICE_PER_1M", "0.075"),
    )
)
...
RAG_SCHEMA_VERSION = os.getenv("RAG_SCHEMA_VERSION", "2026-06-mvp")
RAG_EMBEDDING_MODEL = os.getenv(
    "RAG_EMBEDDING_MODEL",
    "bkai-foundation-models/vietnamese-bi-encoder",
)
RAG_ENABLE_RERANKER = _read_bool_env("RAG_ENABLE_RERANKER", True)
RAG_RERANK_CANDIDATE_MULTIPLIER = int(os.getenv("RAG_RERANK_CANDIDATE_MULTIPLIER", "3"))
...
CONTENT_AUDIO_FAILURE_WINDOW_SECONDS = int(
    os.getenv("CONTENT_AUDIO_FAILURE_WINDOW_SECONDS", "300")
)
CONTENT_AUDIO_RETRY_DELAY_SECONDS = float(
    os.getenv("CONTENT_AUDIO_RETRY_DELAY_SECONDS", "1.5")
)
