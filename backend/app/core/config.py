...
LLM_MAX_CONTEXT_CHARS = int(os.getenv("LLM_MAX_CONTEXT_CHARS", "8000"))
LLM_MAX_CHAT_HISTORY_CHARS = int(os.getenv("LLM_MAX_CHAT_HISTORY_CHARS", "6000"))
LLM_MAX_CHAT_HISTORY_MESSAGES = int(os.getenv("LLM_MAX_CHAT_HISTORY_MESSAGES", "10"))
